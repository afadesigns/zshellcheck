...
func init() {
	RegisterKata(reflect.TypeOf(&ast.BracketExpression{}), Kata{
		...
		Description: "The `[[ ... ]]` construct is a Zsh keyword and is generally safer and more powerful than the `[ ... ]` command. It prevents word splitting and pathname expansion, and supports advanced features like regex matching.",
		Check:       checkZC1016,
	})
}
